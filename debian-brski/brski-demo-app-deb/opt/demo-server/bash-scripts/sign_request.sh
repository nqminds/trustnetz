...
PINNED_CERTIFICATE="/opt/demo-server/certs/pinned-domain-ca.crt"
...
openssl ecparam -genkey -name prime256v1 -out /opt/demo-server/certs/eap-tls-client.key
...
rm -f /opt/demo-server/certs/eap-tls-req-client.crt