...
- a demo web app which may be used for demonstration purposes to interactively and simply enact trust or distrust in a manufacturer or device, binding a device to a device type, and setting a device type to vulnerable or not vulnerable by bind
