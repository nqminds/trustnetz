created(1725350785.73709).
assert(manufacturer_trust(1725349361211,"EvilInc-id","henry@nquiringminds.com")).
assert(device_type_trust("henry@nquiringminds.com",1725349367655,"EvilPhone-id")).
...
assert(user(true,true,true,1725350573532,"henry@nquiringminds.com","henry-user")).
assert(manufacturer_trust(1725349361211,"EvilInc-id","henry@nquiringminds.com")).
assert(device_type_trust("henry@nquiringminds.com",1725349367655,"EvilPhone-id")).
assert(manufacturer_trust(1723716151033,"TrustCorp-id","Henry-id")).
assert(manufacturer_trust(1723716151033,"TrustCorp-id","Ash-id")).
