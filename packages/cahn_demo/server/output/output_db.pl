created(1725538916.1876307).
assert(device_trust("henry@nquiringminds.com",1725538914174,"AshEvilPhone-id")).
...
assert(user(true,false,false,1725354336369,"henry@nquiringminds.com","henry-user")).
