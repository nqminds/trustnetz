created(1725353260.132359).
assert(device_trust("henry@nquiringminds.com",1725352273522,"AshEvilPhone-id")).
...
assert(user(true,false,true,1725351858719,"henry@nquiringminds.com","henry-user")).
