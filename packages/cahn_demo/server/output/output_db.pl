...
assert(manufacturer_trust("Henry-id",1723716151033,"TrustCorp-id")).
assert(manufacturer_trust("Ash-id",1723716151033,"TrustCorp-id")).
assert(manufacturer_trust("Ash-id",1723716151033,"EvilInc-id")).
